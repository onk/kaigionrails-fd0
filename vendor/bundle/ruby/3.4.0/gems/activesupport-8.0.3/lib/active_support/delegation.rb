...
",__FILE__,__LINE__+1;else owner.module_eval"            def respond_to_missing?(name, include_private = false)
              # It may look like an oversight, but we deliberately do not pass
              # +include_private+, because they do not get delegated.
...
",__FILE__,__LINE__+1;end;end;end;end;end
